...
// ─────────────────────────────────────────────────────────────
const optionalAdminAuth = (req, _res, next) => {
    try {
 ...
 */
router.post('/results', validate(saveResultSchema), GameController.saveResult);
/**
 ...
 */
router.get('/leaderboard', optionalAdminAuth, validate(paginationSchema, 'query'), GameController.getLeaderboard);
